...
const Journal = () => {
  ...
  useEffect(() => {
    ...
    console.log(`localStorage.getItem('logDetails') `,localStorage.getItem('logDetails'));
    console.log(`localStorage.getItem('CompanyName') `,localStorage.getItem('CompanyName'));
    console.log(`localStorage.getItem('tdsIdVal') `,localStorage.getItem('tdsIdVal'));
    console.log(`localStorage.getItem('gstIdVal') `,localStorage.getItem('gstIdVal'));
    console.log(`localStorage.getItem('cashIdVal') `,localStorage.getItem('cashIdVal'));
    console.log(`localStorage.getItem('CustId') `,localStorage.getItem('CustId'));
