...
const Add_ledger = (props) => {
  ...
  const submitFinal = handleSubmit((data) => {
    console.log('line 116 data.group_name ',data.group_name);
    ...
    finalObj.amount = '0';
    console.log('line 222 data.open_balance ',data.open_balance,' finalObj.open_balance ',finalObj.open_balance,' finalObj.amount ',finalObj.amount);
    //account id
    ...
    function f() {
      ...
      console.log('line 323 data.open_balance ',data.open_balance,' finalObj1.amount ',finalObj1.amount);
          ...
          if (finalObj1.amount != 0 && finalObj1.amount != '') {
            axios
              ...
              .then(() => {
                ...
                creditFun(finalObj1.crdt_ac,finalObj1.amount,cDate,cTime,'');
