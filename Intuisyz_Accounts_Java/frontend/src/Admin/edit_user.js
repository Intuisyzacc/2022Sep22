...
const Edit_user = (props) => {
  ...
  const submitFinal2 = handleSubmit((data) => {
    // const hashedPassword = bcrypt.hashSync(
    //   data.Password,
    //   '$2a$10$CwTycUXWue0Thq9StjUM0u'
    // ); // hash created previously created upon sign up
    ...
    let finalObj2 = {};
    finalObj2.id = props.EditVal.id;
    //finalObj1.company_name = data.CompanyName;
    finalObj2.user_name = data.UserName;
    finalObj2.password = ciphertext;
    finalObj2.user_type = data.UserType;
    finalObj2.cust_id = props.EditVal.cust_id;

    finalObj2.cashId = props.EditVal.cashId;
    finalObj2.gstId = props.EditVal.gstId;
    finalObj2.tdsId = props.EditVal.tdsId;

    console.log('Add User Data', finalObj2);

    axios
      .put(url + `editUser/${finalObj2.id}`, finalObj2)
      .then(({ data }) => {
        console.log('finalObj2 ',finalObj2);
        console.log('Admin updated');
        successToast('Admin updated');
