...
const Forgot_password = () => {
  ...
  const submitFinal = handleSubmit((data) => {
    ...
    if (newPassword !== cpassword) {
      ...
      console.log('userName',userName,'  ','password',newPassword,' ','cpassword',cpassword);
      ...
      axios
        ...
        .then(({ data }) => {
          ...
          if (data.length === 1) {
            ...
            finalObj.password = ciphertext;
            finalObj.user_id = data[0].user_id;
            finalObj.user_name = data[0].user_name;
            finalObj.user_type = data[0].user_type;
            finalObj.company_name = data[0].company_name;
            finalObj.cust_id = data[0].cust_id;
            finalObj.cashId = data[0].cashId;
            finalObj.gstId = data[0].gstId;
            finalObj.tdsId = data[0].tdsId;
            axios
