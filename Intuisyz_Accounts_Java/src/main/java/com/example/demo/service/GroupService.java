...
public class GroupService {
	...
	public List<Account_group_v3> view_Groups(String CompanyName,String CustId)  {
		
		
				List<Account_group_v3> li=(List<Account_group_v3>) groupServiceRepo.selectData(CompanyName,CustId);
...
public List<Account_group_v3> view_groups_ID(String CompanyName,String CustId)  {
		
		
				List<Account_group_v3> li=(List<Account_group_v3>) groupServiceRepo.selectDatas(CompanyName,CustId);
	...
	public List<Account_group_v3> grp_sorts(String field, String type,String CompanyName,String CustId)  {
		...
		{
			 li=(List<Account_group_v3>) groupServiceRepo.ac_titleA(CompanyName,CustId);
		}
		
		if(field.equals("ac_title")&&type.equals("DESC"))
		{
			 li=(List<Account_group_v3>) groupServiceRepo.ac_titleD(CompanyName,CustId);
		}
		
		if(field.equals("group_name")&&type.equals("ASC"))
		{
			 li=(List<Account_group_v3>) groupServiceRepo.group_nameA(CompanyName,CustId);
		}
		
		if(field.equals("group_name")&&type.equals("DESC"))
		{
			 li=(List<Account_group_v3>) groupServiceRepo.group_nameD(CompanyName,CustId);
		}
		
		if(field.equals("under")&&type.equals("ASC"))
		{
			 li=(List<Account_group_v3>) groupServiceRepo.ac_typeA(CompanyName,CustId);
		}
		
		if(field.equals("under")&&type.equals("DESC"))
		{
			 li=(List<Account_group_v3>) groupServiceRepo.ac_typeD(CompanyName,CustId);
		}
	...
	public List<Account_group_v3> grp_nameSearchs(String grpName,String CompanyName,String CustId)  {
		System.out.println(grpName);
		
		List<Account_group_v3> li=(List<Account_group_v3>) groupServiceRepo.grp_name_searchs(grpName,CompanyName,CustId);
