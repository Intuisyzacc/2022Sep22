...
//	    	ob.setAc_type(acType);
	...
	public List<Account_ledger_v3> list_ledgers_ID(String CompanyName,String CustId)  {
		
		
		List<Account_ledger_v3> li=(List<Account_ledger_v3>) ledgerServiceRepo.selectDatas(CompanyName,CustId);
    ...
    public List<Account_ledger_v3> profit_loss_bn_dates(String title, String start, String end,String CompanyName,String CustId)  {
    	...
    	List<Account_ledger_v3> li=(List<Account_ledger_v3>) ledgerServiceRepo.profit_loss_idSearchByTitle(title);
    	 		...
    	 		for (int i = 0; i < li.size(); i++)   
					...
					System.out.println("li.get(i).getLedger_name() "+li.get(i).getLedger_name());
   ...
   public List<Account_ledger_v3> balanceSheetDataBnDates(String title,String Start, String end,String CompanyName,String CustId)  {
		...
		{ 
			...
			if(!li.get(i).getAmount().equals("0") && !li.get(i).getAmount().equals(""))
			{
				...
				Double amount=Double.parseDouble( li.get(i).getAmount());
				...
				for (int j = 0; j < li1.size(); j++)   
		 		{  	
					...
					System.out.println("li.get(i).getBalance_type() "+li.get(i).getBalance_type()+" Id "+Id+" dbtAc "+ li1.get(j).getDbt_ac()+" CrdtAc "+ li1.get(j).getCrdt_ac()+" li1.get(j).getAmount() "+li1.get(j).getAmount());

					if (li1.get(j).getDbt_ac().equals(Id)) {
		 	 	          debit_total =  (double) (debit_total +Double.parseDouble(li1.get(j).getAmount()));   
		 	 	        }
		 	 	        if (li1.get(j).getCrdt_ac().equals(Id)){
		 	 	          credit_total = (double) (credit_total+Double.parseDouble(li1.get(j).getAmount()));  
		 	 	        }
						System.out.println("Double.parseDouble(li1.get(j).getAmount()) "+Double.parseDouble(li1.get(j).getAmount()));
						System.out.println("(double) Double.parseDouble(li1.get(j).getAmount()) "+(double) Double.parseDouble(li1.get(j).getAmount()));
...
List<Account_ledger_v3> li=(List<Account_ledger_v3>) ledgerServiceRepo.trial_balances(acType,CompanyName,CustId);
 		...
 		for (int i = 0; i < li.size(); i++)   
			...
			li.get(i).setIfsc_code(Double.toString(dbtAmnt));
			li.get(i).setState(Double.toString(crdtAmnt));
...
// 		System.out.println("directIncomeAmount  "+directIncomeAmount);
    ...
    List<Account_ledger_v3> li=(List<Account_ledger_v3>) ledgerServiceRepo.trial_balances(acType,CompanyName,CustId);
     		...
     		for (int i = 0; i < li.size(); i++)   
				...
				Double dbtAmntWithoutOpenBalance=transactionServiceRepo.selectTrialBalanceDbtBnDatesWithoutOpenBalance(id,start,end,CompanyName,CustId);
				...
				System.out.println("dbtAmntWithoutOpenBalance "+dbtAmntWithoutOpenBalance);
     			...
     			Double crdtAmntWithoutOpenBalance=transactionServiceRepo.selectTrialBalanceCrdtBnDatesWithoutOpenBalance(id,start,end,CompanyName,CustId);
