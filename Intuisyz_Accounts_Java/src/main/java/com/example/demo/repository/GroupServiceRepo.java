...
String ss1="select * from account_group_v3 where company_name=?1 OR visibility='All'  order by group_id DESC";
	...
	List<Account_group_v3> selectDatas(String CompanyName,String CustId);
...
String ss11="select * from account_group_v3 where company_name=?1 OR visibility='All'  order by group_name";
